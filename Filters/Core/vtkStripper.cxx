                             ...
                             vtkInformationVector *outputVector)
{
  ...
  // output poly-lines //SK// PATCH APPLIED HERE
  if ( newLines ) {
            ...
            while (!done_this)
              {
                ...
                newLines->InitTraversal(); //SK: init traversal of all polygons so as not to miss previous lines
                int idt = -1;
